...
<div class="row">
    <form class="row g-3" action="{{url('submit-new-application')}}" method="POST">
    	@csrf
        <div><h5>&#9680; Personal Information (According to Service Book)</h5></div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="applicant_name" name ="applicant_name" placeholder="Name of the Applicant">
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="father_husband_name" name="father_husband_name"placeholder="Father's / Husband's Name">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="number" class="form-control form-control-sm" id="mobile_no" name="mobile_no" placeholder="Mobile Number" pattern="\d{10}" maxlength="10">
        ...
        <div><h5>&#9680; Permanent Address</h5></div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="p_address" name="permanent_address" placeholder="Permanent Address">
                <label for="p_address">Address</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="p_city_town_village" name="p_city_town_village" placeholder="Permanent City Town Village">
                <label for="p_city_town_village">City / Town / Village</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="p_post_office" name="p_post_office" placeholder="Post Office">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="p_pin_code" name="p_pin_code" placeholder="Permanent Pin Code" pattern="\d{6}" maxlength="6">
                <label for="p_pin_code">Pin Code</label>
            </div>
        </div>
        <div><h5>&#9680; Present Address</h5></div>
        <div class="form-check mb-3">
            <input type="checkbox" class="form-check-input" id="sameAsPermanent" onchange="copyPermanentAddress()">
            <label class="form-check-label" for="sameAsPermanent"><b>Same as Permanent Address</b></label>
        </div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="present_address" name="present_address" placeholder="Present Address">
                <label for="present_address">Address</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="present_city_town_village" name="present_city_town_village" placeholder="Present City Town Village">
                <label for="present_city_town_village">City / Town / Village</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="present_post_office" name="present_post_office" placeholder="Post Office">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="present_pin_code" name="present_pin_code" placeholder="Present Pin Code" pattern="\d{6}" maxlength="6">
                <label for="present_pin_code">Pin Code</label>
            </div>
        </div>
        <div><h5>&#9680; Applicant's Official Information</h5></div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="number" class="form-control form-control-sm" id="hrms_id" name="hrms_id" placeholder="HRMS ID" pattern="\d{10}" maxlength="10">
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="basic_pay_range" name="basic_pay_range" placeholder="Basic Pay Range">
                <label for="basic_pay_range">Basic Pay Range</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="number" class="form-control form-control-sm" id="basic_pay" name="basic_pay" placeholder="Basic Pay">
                <label for="basic_pay">Basic Pay</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="place_of_posting" name="place_of_posting" placeholder="Place of Posting">
                <label for="place_of_posting">Place of Posting</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="headquarter" name="headquarter" placeholder="Headquarter">
        ...
        <div><h5>&#9680; Name & Address of the Office</h5></div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="name_of_office" name="name_of_office" placeholder="Name of Office">
                <label for="name_of_office">Name of the office</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="office_address" name="office_address" placeholder="Office Address">
                <label for="office_address">Office Address</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="office_city_town_village" name="office_city_town_village" placeholder="Office City Town Village">
                <label for="office_city_town_village">Office City / Town / Village</label>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="office_post_office" name="office_post_office" placeholder="Office Post Office">
                <label for="office_post_office">Post Office</label>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-floating">
                <select class="form-select" id="o_district" name="o_district" aria-label="office district" name="o_district">
                    <option selected="">- Select -</option>
                    @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach
        ...
        <div class="col-md-2">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="office_pin_code" name="office_pin_code" placeholder="Office Pin Code" pattern="\d{6}" maxlength="6">
                <label for="office_pin_code">Pin Code</label>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-floating">
                <input type="number" class="form-control form-control-sm" id="office_phn_no" name="office_phn_no" placeholder="Office Phone Number">
                <label for="office_phn_no">Phone No. (with STD code)</label>
            </div>
        </div>
        <div><h5>&#9680; DDO Details</h5></div>
        <div class="col-md-6">
            <div class="form-floating">
                <select class="form-select" id="ddo_district" name="ddo_district" aria-label="ddo district" name="ddo_district">
                    <option selected="">- Select -</option>
                    <!-- @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach -->
        ...
        <div class="col-md-6">
            <div class="form-floating">
                <select class="form-select" id="ddo_designation" name="ddo_designation" aria-label="ddo designation" name="ddo_designation">
                    <option selected="">- Select -</option>
                    <!-- @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach -->
        ...
        <div><h5>&#9680; Allotment Category</h5></div>
        <div class="col-md-6">
            <div class="form-floating">
                <input type="text" class="form-control form-control-sm" id="flat_type" name="flat_type" placeholder="Flat Type">
                <label for="flat_type">Flat Type</label>
            </div>
        </div>
        <div class="col-md-6">
            <div class="form-floating">
                <select class="form-select" id="allotment_reason" name="allotment_reason" aria-label="allotment reason" name="allotment_reason">
                    <option selected="">- Select -</option>
                    <!-- @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach -->
        ...
        <div><h5>&#9680; Housing Preference</h5></div>
        <div class="col-md-4">
            <div class="form-floating">
                <select class="form-select" id="first_preference" name="first_preference" aria-label="first preference" name="first_preference">
                    <option selected="">- Select -</option>
                    <!-- @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach -->
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <select class="form-select" id="second_preference" name="second_preference" aria-label="second preference" name="second_preference">
                    <option selected="">- Select -</option>
                    <!-- @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach -->
        ...
        <div class="col-md-4">
            <div class="form-floating">
                <select class="form-select" id="third_preference" name="third_preference" aria-label="third preference" name="third_preference">
                    <option selected="">- Select -</option>
                    <!-- @foreach ($districts as $district)
                    <option value="{{ $district->district_code }}">{{ $district->district_name }}</option>
                    @endforeach -->
        ...
        <div><h5>&#9680; Upload Documents</h5></div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <p><small><b>Allowed Extension: jpg, jpeg<br>Dimensions: 140 pixels (Width) x 60 pixels (Height)<br>Maximum File Size: 50 KB</b></small></p>
        </div>
